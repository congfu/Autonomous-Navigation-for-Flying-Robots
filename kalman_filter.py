# The code below implements a linear Kalman filter. The state_callback method is invoked in every simulation step and performs one Kalman filter prediction step (200Hz). The measurement_callback method is called when a new GPS sensor reading arrives and calculates the Kalman filter correction step (13Hz). The GPS reading gives a noisy measurement of the absolute position in world coordinates.
